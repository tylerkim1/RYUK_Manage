        ...
        <div id="menu-user-container" style={{display: 'flex', flexDirection: 'column', height: '100%'}}>
            ...
            <div id="menu-user-body" style={{display: 'flex', flex: 7, paddingLeft: '2rem'}}>
                <div id="today-mission">
                    ...
                    <div id="list-mission" style={{display: 'flex', overflowX: 'auto', whiteSpace: 'nowrap', gap: '2rem' }}> 
                        <div id="mission" style={{display: 'flex', flexDirection: 'column', width: '20rem', height: '35rem', backgroundColor: '#FFFFFF', borderRadius: '1rem', padding: '0 1rem 0 1rem'}}>
                            <div id="mission-header" style={{display: 'flex', flex: 1}}>
                                <div id="mission-title" style={{display: 'flex', flex: 7, alignItems: 'center'}}>
                                    <span style={{fontSize: '1.2rem', fontWeight: '800'}}>
                                        미션 1
                                    </span>
                                </div>
                                <div id="mission-`isComplete" style={{display: 'flex', flex: 1, alignItems: 'center', justifyContent: 'center'}}>
                                    <img src={isCheckImage} alt="user" style={{ width: '1.2rem', height: '1.2rem' }} />
                                </div>
                                <div id="mission-sendMsg" style={{display: 'flex', flex: 1, alignItems: 'center', justifyContent: 'center'}}>
                                    <img src={canSendMsgImage} alt="user" style={{ width: '1.2rem', height: '1.2rem' }} />
                                </div>
                            </div>
                            <div id="mission-body" style={{display: 'flex', flexDirection: 'column', flex: 5}}>
                                <div id="mission-img" style={{display: 'flex', flex: 2, marginBottom: '1rem'}}>
                                    <img src={missionImage} alt="user" style={{ width: '100%', height: '100%' }} />
                                </div>
                                <div id="mission-desc" style={{display: 'flex', flex: 1}}>
