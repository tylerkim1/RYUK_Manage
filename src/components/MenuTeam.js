...
const MenuTeam = () => {
  const { teams, teamNums, members, newTeam, setNewTeam, initTeam, addTeam, deleteTeam, getMembers, appliedMembers, setAppliedMembers, getAppliedMembers, assignUser } = useTeam();
